...
import ParentPostComponent from './ParentPostComponent';
...
const IdPost = ({removeBookmarkOnPage,  id, remove, reposted}:IdPostPropsTypes) => {
  ...
  return (
            <Card className='rounded-xl w-full m-0 bg-black thin-border pb-2 border-l-0 border-r-0 hover:bg-gray-950 my-2'>
              <div>
                {postData?.parent &&  
                <ParentPostComponent
                    id={postData?.parent}
